...
read_when:
  - 您想要使用 Synthetic 作为模型提供商
  - 您需要 Synthetic API 密钥或基本 URL 设置
title: "Synthetic"
---

# Synthetic

Synthetic 暴露了 Anthropic 兼容的端点。OpenClaw 将其注册为
...
`https://api.synthetic.new/anthropic`（而不是 `/anthropic/v1`）。如果 Synthetic 更改了其基础 URL，请覆盖 `models.providers.synthetic.baseUrl`。

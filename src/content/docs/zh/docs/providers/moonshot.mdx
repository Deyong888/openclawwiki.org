...
read_when:
  - 您想要 Moonshot K2 (Moonshot 开放平台) vs Kimi Coding 设置
  - 您需要了解独立的端点、密钥和模型引用
  - 您想要任一提供商的复制/粘贴配置
title: "Moonshot AI"
---
...
Moonshot 提供带有 OpenAI 兼容端点的 Kimi API。配置提供商并将默认模型设置为 `moonshot/kimi-k2.5`，或使用 Kimi Coding 配合 `kimi-coding/k2p5`。

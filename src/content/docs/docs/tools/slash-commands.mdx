...
- `/tts off|always|inbound|tagged|status|provider|limit|summary|audio` (control TTS; see [/tts](/docs/tts))
...
Text-only:
- `/compact [instructions]` (see [/concepts/compaction](/docs/concepts/compaction))

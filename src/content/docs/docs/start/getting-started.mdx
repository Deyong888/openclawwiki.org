...
Docs: [Dashboard](/docs/web/dashboard) and [Control UI](/docs/web/control-ui).
...
If you want the deeper reference pages, jump to: [Wizard](/docs/start/wizard), [Setup](/docs/start/setup), [Pairing](/docs/start/pairing), [Security](/docs/gateway/security).
...
- **Recommended:** Brave Search API key for web search. Easiest path:
  ...
  See [Web tools](/docs/tools/web).

macOS: if you plan to build the apps, install Xcode / CLT. For the CLI + gateway only, Node is enough.
Windows: use **WSL2** (Ubuntu recommended). WSL2 is strongly recommended; native Windows is untested, more problematic, and has poorer tool compatibility. Install WSL2 first, then run the Linux steps inside WSL. See [Windows (WSL2)](/docs/platforms/windows).
...
Installer options (install method, non-interactive, from GitHub): [Install](/docs/install).
...
Wizard doc: [Wizard](/docs/start/wizard)
...
WhatsApp doc: [WhatsApp](/docs/channels/whatsapp)

### Telegram / Discord / others

The wizard can write tokens/config for you. If you prefer manual config, start with:
- Telegram: [Telegram](/docs/channels/telegram)
- Discord: [Discord](/docs/channels/discord)
- Mattermost (plugin): [Mattermost](/docs/channels/mattermost)
...
Pairing doc: [Pairing](/docs/start/pairing)
...
- macOS menu bar app + voice wake: [macOS app](/docs/platforms/macos)
- iOS/Android nodes (Canvas/camera/voice): [Nodes](/docs/nodes)
- Remote access (SSH tunnel / Tailscale Serve): [Remote access](/docs/gateway/remote) and [Tailscale](/docs/gateway/tailscale)
- Always-on / VPN setups: [Remote access](/docs/gateway/remote), [exe.dev](/docs/platforms/exe-dev), [Hetzner](/docs/platforms/hetzner), [macOS remote](/docs/platforms/mac/remote)

---
title: Raspberry Pi
description: OpenClaw on Raspberry Pi (budget self-hosted setup).
sidebar:
  label: Raspberry Pi
  order: 6
---
...
- [Linux guide](/docs/install/linux) — general Linux setup
- [Docker setup](/docs/install/docker)
- [Nodes](/docs/concepts/architecture) — pair your laptop/phone with the Pi gateway

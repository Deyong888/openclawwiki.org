...
## Configuration
Key settings (see [/docs/gateway/configuration](/docs/gateway/configuration) for shared channel patterns):
...
## Routing & Sessions
- Session keys follow the standard agent format (see [/docs/concepts/session](/docs/concepts/session)):
...
- See [/docs/gateway/configuration](/docs/gateway/configuration) for `dmPolicy` and allowlist gating.
